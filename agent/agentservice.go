...
func (as *AgentService) Register(cont context.Context, msg *ClientRegMsg) (*ClientRegMsg, error) {
...
func (as *AgentService) Forward(stream Client_ForwardServer) error {
